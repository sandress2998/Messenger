...
import ru.mephi.chatservice.annotation.TimeBusinessOperation
...
class TimerAspectConfig(private val meterRegistry: MeterRegistry) {
    ...
    @Around("@annotation(ru.mephi.chatservice.annotation.TimeHttpRequest)")
    fun measureHttpRequest(joinPoint: ProceedingJoinPoint): Any? {
        return httpRequestTimer.recordCallable { joinPoint.proceed() }
    }

    @Around("@annotation(ru.mephi.chatservice.annotation.TimeDatabaseQuery)")
